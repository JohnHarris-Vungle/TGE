...
TGE.Sprite.prototype =
    {
        ...
        setImage: function(arg1,rows,columns,width,height)
        {
            ...
            {
                this._mRendererTexture = this._mFullStage._mRenderer.processImage(arg1,false);
            }
            else if(arg1 && arg1.spriteSheet instanceof Image)
            {
                ...
                this._mRendererTexture = this._mFullStage._mRenderer.processImage(arg1.spriteSheet,true);
                var sheetInfo = arg1;
            }
